Rails.application.configure do
  ...
  # SECURITY NOTE: Uncomment this in production
  ...
  # Change to :info in production to avoid logging sensitive information
  # SECURITY: Changed from :debug to :info (was security vulnerability)
